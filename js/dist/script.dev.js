...
$(".card .addtocart input").val("إضافة إلى العربة"); // $(".card .btn input").click(
//     function () {
//         $("a.cart.iconRound").addClass("animate__headShake");
//     }
// );

var cart = $("a.cart.iconRound i");
...
$(".modal").addClass("animate__animated animate__zoomIn animate__faster"); // ; (function (document, window, index) {
...
var $editBtn = $('.input-group .edit-btn');
var $editInput = $('.input-group .edit-input');
$editBtn.click(function () {
  $editInput.removeAttr("disabled");
  $editInput.prop("placeholder", "أضف اسمك الجديد");
});
var $editBtnEmail = $('.input-group .edit-btn-email');
var $editInputEmail = $('.input-group .edit-input-email');
...
$productCounter.attr("min", "1"); // $(document).ready(function () {
